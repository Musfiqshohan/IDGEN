    ...
    for epc in range(lastepc, params.epoch):
        ...
        if (epc + 1) % params.interval == 0:
            ...
            with torch.no_grad():
                ...
                final_imgs = torch.cat([final_conds, final_samples], dim=1) #(b, 9, 32, 32)   #matt
...
def main():
    ...
    parser.add_argument('--labkey_1', type=str, required=True, help='which key contains the discrete conditioning')    
    ...
    parser.add_argument('--clsnum_1',type=int,default=10,help='num of label classes')
